...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_ENT,     TG(_EINS),KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TAB  |      |   W  |      |      | F11  |                    |  F12 |      |  UP  | DEL  |  [{  | ]}   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |   A  |   S  |   D  |      |      |-------.    .-------| HOME | LEFT | DOWN | RGHT |  ' " | ENT  |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
...
[_EINS] = LAYOUT( \
  ...
  KC_TAB,   KC_NO,   KC_W,    KC_NO,    KC_NO,    KC_F11,                        KC_F12,    KC_NO,    KC_UP,    KC_DEL,   KC_LBRC,  KC_RBRC, \
  KC_NO,    KC_A,    KC_S,    KC_D,     KC_NO,    KC_NO,                         KC_HOME,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_QUOT,  KC_ENT, \
  KC_LSFT,  KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_NO, KC_NO,      TG(_EINS),  KC_END,    KC_INS,   KC_NO,    KC_NO,    KC_NO,    KC_RSFT, \
